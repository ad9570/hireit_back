            ...
            <div className='footer footer-top'>
                <div className='nav-links-wrap'>
                    ...
                    <div className="nav-links-links">
                        <a href="#" target='_blank' style={{textDecoration:'none'}}>기업소개</a>
                        <a href="#" target='_blank' style={{textDecoration:'none'}}>이용약관</a>
                        <a href="#" target='_blank' style={{textDecoration:'none'}}>개인정보 처리방침</a>
                        <a href="#" target='_blank' style={{textDecoration:'none'}}>고객정보</a>
                    </div>
                </div>
            </div>
