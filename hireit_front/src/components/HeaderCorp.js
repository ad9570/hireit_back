        ...
        <div className='corp-header-wrap'>
            <div className="corp-header-container">
                <div className="corp-header-nav-home-wrap">
                    <a href="" className="corp-header-nav-home" style={{textDecoration:'none'}}>
                        하이어잇 기업 서비스
                    </a>
                </div>
                <div className="corp-header-nav-buttons-wrap">
                    <div className="corp-login-signup">
                        {corpLogin?<a href="" className='corp-login-sign' style={{textDecoration:'none'}}>로그아웃</a>:<><a href="" className="corp-login corp-login-sign" style={{textDecoration:'none'}}>
                            채용담당자 로그인
                        </a>
                        <a href="" className="corp-signup corp-login-sign" style={{textDecoration:'none'}}>
                            관리자 가입
                        </a></>}
                    </div>
                    ...
                    <button className="corp-home-button">
                        ...
                        <a style={{color:'#666',textDecoration:'none'}} href="/">하이어잇 홈</a>
                    </button>
                </div>
            </div>
        </div>
