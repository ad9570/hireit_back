...
const ResumeUpdate = () => {
    ...
    const handleClose = () => {
        Navi("/resume/detail/" + user_id + "/" + resume_idx);
    }
    ...
    const confirmRes = (e) => {
        ...
        if (!window.confirm("이력서를 수정하시겠습니까?")) {
            ...
            axios.post(updateresume, {
                resume_idx, user_id, username, name, user_hp, user_photo, addr, user_addr, user_birth, user_email, user_gender, sch_name, sch_region, sch_start, sch_end, sch_major,
        ...
        <div className='ResumeInput'>
            ...
            <form onSubmit={confirmRes}>
                <div className='ResumeInputForm'>
                    {/* 기본정보 */}
                    <UserInfo user_gender={user_gender} user_birth={user_birth} user_email={user_email} user_hp={user_hp} addr={addr}
                    ...
                    <div className="ButtonUpdate">
                        ...
                        <button type='submit' className='btn btn-outline-dark'>수정</button>
                        <Modal
                            open={open}
                            onClose={handleClose}
